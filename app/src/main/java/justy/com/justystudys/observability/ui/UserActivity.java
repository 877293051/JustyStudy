...
package justy.com.justystudys.observability.ui;
...
import justy.com.justystudys.observability.Injection;
...
//        mUpdateButton = findViewById(R.id.update_user);
        mUserName = new TextView(this);
        mUserNameInput = new EditText(this);
        mUpdateButton = new Button(this);
        LinearLayout linearLayout = new LinearLayout(this);
        linearLayout.setOrientation(LinearLayout.VERTICAL);
        linearLayout.addView(mUserName);
        linearLayout.addView(mUserNameInput);
        linearLayout.addView(mUpdateButton);
